...
export const validationSchema = Yup.object({
    ...
    inputTreatyDetail: Yup.object({
        ...
        treatyPriorYear: Yup.object({
            priorExchange: Yup.number().notRequired(),
