...
const OpeningFundInput = ({ amount, isNegative, handleCheckboxChange, handleAmountInput }: { amount: string, isNegative: boolean, handleCheckboxChange: (e: React.ChangeEvent<HTMLInputElement>) => void, handleAmountInput: (e: React.ChangeEvent<HTMLInputElement>) => void }) => (
